...
const Payments = () => {
    ...
    const fetchPayments = async () => {
      try {
        ...
        Swal.fire({
          ...
          text: 'Could not load your payment information.',
  ...
  const viewReceipt = async (id) => {
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Failed',
        text: 'Could not load payment receipt.',
        confirmButtonColor: '#0F4C81',
      });
    } finally {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      // Wait for logo/images to finish loading
      ...
      const receiptNumber =
        selectedPayment.receiptNumber || 'payment-receipt';
      ...
      Swal.fire({
        ...
        text: 'Your payment receipt has been saved as PDF.',
        confirmButtonColor: '#0F4C81',
        timer: 1800,
      ...
      Swal.fire({
        icon: 'error',
        title: 'PDF Failed',
        text: 'Could not generate the payment receipt PDF.',
        confirmButtonColor: '#0F4C81',
      });
    } finally {
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Payment history, receipts and outstanding balance
          </p>
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Professional IT & Computer Training
                      </div>
